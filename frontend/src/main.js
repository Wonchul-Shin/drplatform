...
pluralCaseList.push( {plural: "drs/drs", pascal: "DrDr"} )

pluralCaseList.push( {plural: "responses/responses", pascal: "ResponseResponse"} )

pluralCaseList.push( {plural: "kepcos/kepcos", pascal: "KepcoKepco"} )
